<template xmlns: xmlns: xmlns: xmlns: xmlns:>
  <div class="bot">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i>BOT算法测试</a></li>
      ...
      <section class="content">
        ...
        <div class="box box-default color-palette-box">
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-tag"></i> 总览</h3>
          </div>
          <div class="box-body">
            <div class="row">
        ...
        <div class="box box-default color-palette-box">
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-tag"></i> 分类通过率</h3>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-xs-12">
                        ...
                        <div class="info-box-content">
                          ...
                          <div class="progress">
                            <div class="progress-bar bg-light-blue"
                                 v-bind:style="{width: calculatePercentage(e) + '%'}"></div>
                          </div>
        ...
        <div class="box box-default color-palette-box">
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-tag"></i> 错误用例分析</h3>
          </div>
          <div class="box-body">
            <div class="row">
